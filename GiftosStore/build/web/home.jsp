<%-- 
    Document   : home
    Created on : 14-10-2023, 18:07:30
    Author     : VietBao
--%>
...
<html>
    ...
    <body>                  
                            ...
                            <div class="carousel-item ">
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 ">
                                            <div class="img-box">
                                                <img src="images/slider-man.png" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="carousel-item ">
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 ">
                                            <div class="img-box">
                                                <img src="images/slider-girl.png" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <!-- BEST SAVINGS ON NEW ARRIVALS section -->
        ...
        <!-- end BEST SAVINGS ON NEW ARRIVALS section -->

        <!-- WHY SHOP WITH US section -->
        <section class="why_section layout_padding">
            <div class="container">
                <div id="hihihi" class="heading_container heading_center">
                    <h2 >
                        Why Shop With Us
                    </h2>
                </div>
                    ...
                    <div class="col-md-4">
                        <div class="box ">
                            ...
                            <div class="detail-box">
                                ...
                                <p>
                                    Chất lượng đi đôi với dịch vụ
                                    <br>
                                    Tin cậy - An toàn - Miễn phí
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <!-- GIFTS FOR YOUR LOVED ONES section -->
        ...
        <!-- end GIFTS FOR YOUR LOVED ONES section -->
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <div class="box">
                                ...
                                <p>
                                    Sản phẩm thật là tuyệt vời lun
                                </p>
                            </div>
                        </div>
                        <div class="carousel-item">
            ...
            <footer class=" footer_section">
                <div class="container">
                    <p>
                        ...
                        <a href="https://html.design/">nguyen tv bao cute pho mai que</a>
                    </p>
                </div>
            </footer>
            <!-- footer section -->
