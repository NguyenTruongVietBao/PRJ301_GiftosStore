...
public class AddCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = ERROR;
        try {
//            String strFruit = request.getParameter("cmbFruit");
//            String tmp[] = strFruit.split("-");
//            String id = tmp[0];
//            String name = tmp[1];
//            double price = Double.parseDouble(tmp[2]);
//            int quantity = Integer.parseInt(request.getParameter("cmbQuantity"));
//            Product product = new Product(id, name, quantity, quantity, quantity, name, strFruit, name, category);
