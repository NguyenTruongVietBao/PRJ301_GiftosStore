...
// <-!---------GET PRODUCT BY CATEGOIRY ID------------------------------------------------------------!->   
    private static final String GET_PRODUCT_BY_CATEGORYID = "SELECT id, title,price,quantity,discount,thumbnail,description,created_at, updated_at,deleted,category_id "
